...
const Sidebar = () => {
  ...
  return (
    ...
    {/* Mobile view */}
      ...
      <div className="md:hidden px-1 py-5 h-[650px] hover:overflow-x-hidden overflow-y-scroll w-[30px] pt-14">
        <div>
    ...
    {/* Desktop view */}
      ...
      <div className="hidden md:block px-1 py-5 h-[685px] hover:overflow-x-hidden overflow-y-scroll w-[260px] pt-14">
        <div>
